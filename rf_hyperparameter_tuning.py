...
def perform_grid_search(X_train, y_train):
    ...
    param_grid = {
        ...
        'max_depth': [5, 10, 15, 20, 25, None],    # Maximum depth of the tree. If None, nodes are expanded until all leaves are pure.
...
if __name__ == "__main__":
    ...
    # Process data
    X_train, _ = preprocess_data(train_data, train_data)  # Preprocess train_data twice since test_data is not needed here
