...
def preprocess_user_input(user_input):
    ...
    processed_input = pd.get_dummies(processed_input, columns=['Sex', 'Embarked', 'Title', 'AgeBin', 'FareBin'])

    # List of required columns in the order used during training
    required_columns = [
        'Pclass', 'SibSp', 'Parch', 'Fare', 'Age', 'FamilySize', 'IsAlone', 'HasCabin',
        ...
        'Title_Rev', 'Title_Sir', 'AgeBin_Child', 'AgeBin_Teen', 'AgeBin_Adult',
        'AgeBin_MiddleAged', 'AgeBin_Senior', 'FareBin_Low', 'FareBin_Below_Average',
        'FareBin_Above_Average', 'FareBin_High'
    ]
